    ...
    return (
        <div className="flex justify-center px-4 py-10">
            ...
            <div className="w-[20%] h-[480px] flex flex-col p-3 border-[1px] border-gray-300 rounded-md shadow gap-3">
                ...
                {
                    product?.stock ? <span className='text-xl text-[#007600] font-bodyFont'>In stock</span> : <span className='text-xl text-red-600 font-bodyFont'>Out of Stock</span>
                }
...

                {
                    product?.stock ? (
                        ...
                        :
                        <div>
                            <button id='button' className='w-full font-titleFont font-medium text-base bg-[#ffa41c] hover:bg-[#FA8900]  duration-200 py-1.5 rounded-md mt-3' disabled>Out of stock</button>
                        </div>
