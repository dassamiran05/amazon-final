...
const Home = ({handleAddtoCart, handleDelete, products, category}) => {
    return (
        <div>
            <Banner></Banner>
            <div className='w-full -mt-14 xl:-mt-36 py-10'>
                <Products handleAddtoCart={handleAddtoCart} handleDelete={handleDelete} products={products} category={category}></Products>
            </div>
